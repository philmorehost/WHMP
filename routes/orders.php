...
use CodeVault\Billing\AdminOrderController;
use CodeVault\Billing\OrderController;

/** @var CodeVault\Router $router */

$router->get('/admin/orders', [OrderController::class, 'index']);
$router->get('/admin/orders/create', [AdminOrderController::class, 'createForm']);
$router->post('/admin/orders', [AdminOrderController::class, 'store']);
