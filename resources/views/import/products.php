...
<div class="cv-card" style="margin-bottom:var(--cv-space-4);">
    <h1 class="cv-card__title">Import Products</h1>
...
<div class="cv-card" style="margin-bottom:var(--cv-space-4);">
    ...
    <p style="color:var(--cv-text-secondary);">
        ...
        <code>name</code>, <code>description</code>, <code>group</code>, <code>status</code>, <code>setup_fee</code>,
        <code>one_time_price</code>, <code>monthly_price</code>, <code>quarterly_price</code>, <code>semi_annually_price</code>,
        <code>annually_price</code>, <code>biennially_price</code>, <code>triennially_price</code>.
        <code>name</code> and <code>group</code> are required — the group is created automatically if it doesn't already exist.
        A product with a matching name (case-insensitive) is updated in place rather than duplicated; only billing-cycle columns present in the row are written, so a partial re-import won't remove pricing for cycles it doesn't mention.
        <code>status</code> defaults to <code>active</code> when left blank.
    </p>
    <form method="post" action="/admin/import/products" enctype="multipart/form-data"><?= csrf_field() ?>
        <div class="cv-field">
