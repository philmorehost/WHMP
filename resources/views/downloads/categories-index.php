...
<div class="cv-card" style="margin-bottom:var(--cv-space-4);">
    <h1 class="cv-card__title">Download Categories</h1>
...
<div class="cv-card">
    <table class="cv-table">
        ...
        <?php foreach ($categories as $category): ?>
            <tr>
                ...
                <td>
                    <form method="post" action="/admin/downloads/categories/<?= (int) $category['id'] ?>/delete"><?= csrf_field() ?>
    ...
    <h3>Add Category</h3>
    <form method="post" action="/admin/downloads/categories" style="display:flex;gap:var(--cv-space-2);align-items:end;flex-wrap:wrap;"><?= csrf_field() ?>
