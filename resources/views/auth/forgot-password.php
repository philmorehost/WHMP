...
<div class="cv-card">
    ...
    <?php else: ?>
        <p style="color:var(--cv-text-secondary);">Enter your admin account email and we'll send you a link to reset your password.</p>
        <form method="post" action="/login/forgot-password"><?= csrf_field() ?>
            <div class="cv-field">
