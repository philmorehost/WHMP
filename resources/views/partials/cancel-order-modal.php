    ...
    <div style="background:var(--cv-bg-surface);border-radius:12px;padding:32px;max-width:500px;width:90%;border:1px solid var(--cv-border-default);">
        ...
        <form method="post" action="/client/orders/<?= (int)$order['id'] ?>/cancel">
            ...
            <div style="display:flex;gap:12px;justify-content:flex-end;">
                <button type="button" data-cancel-order-close style="padding:10px 20px;background:var(--cv-bg-surface-sunken);color:var(--cv-text-primary);border:1px solid var(--cv-border-default);border-radius:6px;cursor:pointer;font-weight:600;">Keep Order</button>
...
<button type="button" data-cancel-order-open style="padding:10px 16px;background:rgba(239,68,68,.2);color:#ef4444;border:1px solid rgba(239,68,68,.3);border-radius:6px;cursor:pointer;font-weight:600;font-size:.9rem;">🗑️ Cancel Order</button>
